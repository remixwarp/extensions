...
`;
  ...
  const definitions = [
    ...
    },
    {
      opcode: "clearColor",
      blockType: BlockType.COMMAND,
      text: "设置清晰颜色 R：[RED] G：[GREEN] B：[BLUE] A：[ALPHA]",
      arguments: {
        RED: {
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 立方体纹理坐标 UVW [U] [V] [W]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 立方体纹理 [SIDE] [TEXTURE] [WRAP] [FILTER]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 纹理多级渐远纹理 [MIPMAPPING]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 骨骼索引 [INDICES] 权重 [WEIGHTS] 每个顶点的数量 [COUNT]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] [TRANSFORMS] 变换 [MATRIXES]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      text: "设置 [NAME] 优化接下来上传的列表 以便能按 [USAGE] 进行更新",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 从 [FILETYPE] [SRCLIST]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 丢弃不透明度低于 [ALPHATEST] 的像素 对于通过测试的像素执行 [MAKEOPAQUE] 操作",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置 [NAME] 顶点的绘制范围为从 [START] 到 [END]",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          defaultValue: "my mesh",
    ...
    },
    {
      ...
      blockType: BlockType.REPORTER,
      text: "文本生成的纹理 [TEXT] 字体 [FONT] 颜色 [COLOR]",
      arguments: {
        TEXT: {
          type: ArgumentType.STRING,
    ...
    },
    {
      ...
      blockType: BlockType.REPORTER,
      text: "文本生成纹理 [TEXT] 字体 [FONT] 颜色 [COLOR] 边框 [BORDERSIZE] [BORDERCOLOR]",
      arguments: {
        TEXT: {
          type: ArgumentType.STRING,
          defaultValue: "Hello World!",
    ...
    },
    {
      ...
      blockType: BlockType.REPORTER,
      text: "来自列表 [NAME] 中位于 [POS] 处 尺寸为 [WIDTH] [HEIGHT] 的纹理",
      arguments: {
        NAME: {
          type: ArgumentType.STRING,
          menu: "lists",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "从视角开始 视场角：[FOV] 近平面：[NEAR] 远平面：[FAR]",
      arguments: {
        FOV: {
          type: ArgumentType.NUMBER,
          defaultValue: 90,
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "从保存在 [SRCLIST] 中 [POS] 位置的内容开始",
      arguments: {
        SRCLIST: {
          type: ArgumentType.STRING,
          menu: "lists",
...

    {
      ...
      blockType: BlockType.COMMAND,
      text: "将 X：[X] Y：[Y] Z：[Z] 从 [FROM] 转换为 [TO]",
      arguments: {
        X: {
          type: ArgumentType.NUMBER,
        },
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "将 [BOXTYPE] 设置为X1:[X1] Y1:[Y1] X2:[X2] Y2:[Y2]",
      arguments: {
        BOXTYPE: {
          type: ArgumentType.STRING,
          menu: "boxType",
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "设置全局颜色 [OPERATION] 红色：[RED] 绿色：[GREEN] 蓝色：[BLUE] 透明度：[ALPHA]",
      arguments: {
        OPERATION: {
          type: ArgumentType.STRING,
          menu: "globalColor",
    ...
    },
    {
      opcode: "setFogColor",
      blockType: BlockType.COMMAND,
      text: "设置雾的颜色 R：[RED] G：[GREEN] B：[BLUE]",
      arguments: {
        RED: {
          type: ArgumentType.NUMBER,
          defaultValue: 1,
    ...
    },
    {
      ...
      blockType: BlockType.COMMAND,
      text: "将雾的 [SPACE] 原点设置在X：[X] Y：[Y] Z：[Z]",
      arguments: {
        SPACE: {
          type: ArgumentType.STRING,
